...
final class DataProviderTests: XCTestCase {
    ...
    func testCellForRowAtIndexPathDequeuesCellFromTableView() {
        ...
        XCTAssertTrue(mockTableView.cellIsDesqueued)
    }
    
    func testcellForRowInSecttionZeroCallConfigure() {
        let mockTableView = MockTableView.mockTableView(withDataSource: sut)
    ...
    func testcellForRowInSecttionOneCallConfigure() {
        let mockTableView = MockTableView.mockTableView(withDataSource: sut)
    ...
    extension DataProviderTests {
        class MockTableView: UITableView {
            var cellIsDesqueued = false
            
            static func mockTableView(withDataSource dataSource: UITableViewDataSource) -> MockTableView {
                let mockTableView = MockTableView(frame: CGRect(x: 0, y: 0, width: 361, height: 759), style: .plain)
